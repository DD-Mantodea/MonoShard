...
{
    public class EntityMoveAnimation : Animation<Entity>
    {
        public EntityMoveAnimation(Vector2 end, Entity target, string tag = "") : base(target, 14, tag)
        {
            _end = end;

            _maxRotation = ((float)Core.Random.NextDouble() - 0.5f) / 3;
